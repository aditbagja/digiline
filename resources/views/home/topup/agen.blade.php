        ...
        <div class="col-lg-12 grid-margin"> 
          <div class="card">
            <div class="card-body mb-3">
                <h2>Agen Isi Saldo<h2>
                <h4><small class="text-muted">Saya akan topup saldo menggunakan Agen Isi Saldo</small></h4><hr>
                <div class="container d-grid mb-3">
                    <button type="button" class="btn btn-outline-primary btn-fw" style="text-align: left">
                    <div class="row">
                      <div class="col align-self-center">
                        <img src="/assets/img/images/merchant.png" width="70" height="50"> Alfamart/Indomaret
                      </div>
                ...
                <div class="mb-3" style="text-align: center">
                    <h2>DigiLine ID (Nomor Telepon Kamu)</h2>
                    <h1 class="text-danger">{{ Auth::user()->no_telp }}</h1>
                ...
                <div class="mb-3">
                    <button class="accordion">Cara isi Saldo DigiLine</button>
                    <div class="panel">
