        ...
        <div class="col-lg-12 grid-margin"> 
          <div class="card">
            <div class="card-body mb-3">
                <h2>DANA<h2>
                <h4><small class="text-muted">Saya akan topup saldo menggunakan DANA</small></h4><hr>
                <div class="container d-grid mb-3">
                    <button type="button" class="btn btn-outline-primary btn-fw" style="text-align: left">
                    <div class="row">
                      <div class="col align-self-center">
                        <img src="/assets/img/images/DANA.png" width="50" height="50"> DANA
                      </div>
                ...
                <div class="mb-3">
                  <button class="accordion">DANA Apps</button>
                  <div class="panel">
