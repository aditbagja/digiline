        ...
        <div class="col-lg-12 grid-margin"> 
          <div class="card">
            <div class="card-body mb-3">
                <h2>OVO<h2>
                <h4><small class="text-muted">Saya akan topup saldo menggunakan OVO</small></h4><hr>
                <div class="container d-grid mb-3">
                    <button type="button" class="btn btn-outline-dark btn-fw" style="text-align: left">
                    <div class="row">
                      <div class="col align-self-center">
                        <img src="/assets/img/images/ovo.png" width="50" height="50"> OVO
                      </div>
                ...
                <div class="mb-3">
                  <button class="accordion">OVO Apps</button>
                  <div class="panel">
