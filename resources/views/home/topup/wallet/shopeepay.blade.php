        ...
        <div class="col-lg-12 grid-margin"> 
          <div class="card">
            <div class="card-body mb-3">
                <h2>Shopeepay<h2>
                <h4><small class="text-muted">Saya akan topup saldo menggunakan Shopeepay</small></h4><hr>
                <div class="container d-grid mb-3">
                    <button type="button" class="btn btn-outline-danger btn-fw" style="text-align: left">
                    <div class="row">
                      <div class="col align-self-center">
                        <img src="/assets/img/images/Shopeepay.png" width="50" height="50"> Shopeepay
                      </div>
                ...
                <div class="mb-3" style="text-align: center">
                    <h2>Nomor Virtual Akun Shopeepay</h2>
                ...
                <div class="mb-3">
                  <button class="accordion">Shopeepay Apps</button>
                  <div class="panel">
