        ...
        <div class="col-lg-12 grid-margin"> 
          <div class="card">
            <div class="card-body mb-3">
                <h2>BANK BNI<h2>
                <h4><small class="text-muted">Saya akan topup saldo menggunakan BANK BNI</small></h4><hr>
                <div class="container d-grid mb-3">
                    <button type="button" class="btn btn-outline-danger btn-fw" style="text-align: left">
                    <div class="row">
                      <div class="col align-self-center">
                        <img src="/assets/img/images/BNI.png" width="70" height="50"> BANK BNI
                      </div>
                ...
                <div class="mb-3" style="text-align: center">
                    <h2>Nomor Virtual Akun BANK BNI</h2>
